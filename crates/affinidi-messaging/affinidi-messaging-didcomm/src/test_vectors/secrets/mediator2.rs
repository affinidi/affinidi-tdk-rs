...
lazy_static! {
    pub static ref MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_X25519_1: Secret = Secret::from_str(
    ...
    pub static ref MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_P256_1: Secret = Secret::from_str(
    ...
    pub static ref MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_P384_1: Secret = Secret::from_str(
    ...
    pub static ref MEDIATOR2_SECRET_KEY_AGREEMENT_KEY_P521_1: Secret = Secret::from_str(
    ...
    pub static ref MEDIATOR2_SECRETS: Vec<Secret> = vec![
