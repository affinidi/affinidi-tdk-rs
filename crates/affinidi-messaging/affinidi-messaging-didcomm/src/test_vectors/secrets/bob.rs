...
lazy_static! {
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_X25519_1: Secret = Secret::from_str(
...
).expect("Couldn't create key from string");
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_X25519_2: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_X25519_3: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_P256_1: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_P256_2: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_P384_1: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_P384_2: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_P521_1: Secret = Secret::from_str(
    ...
    pub static ref BOB_SECRET_KEY_AGREEMENT_KEY_P521_2: Secret = Secret::from_str(
