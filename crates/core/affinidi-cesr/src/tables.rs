...
pub fn matter_sizage(code: &str) -> Option<Sizage> {
    ...
    let sizage = match code {
        ...
        // Seed 128 bit random
        "J" => Sizage { hs: 1, ss: 0, fs: 24, ls: 0 },
        // Seed 256 bit random
        "K" => Sizage { hs: 1, ss: 0, fs: 44, ls: 0 },
        // Salt 128 bit random
        "L" => Sizage { hs: 1, ss: 0, fs: 24, ls: 0 },
        ...
        // Blake3-512 digest
        "1AAH" => Sizage { hs: 4, ss: 0, fs: 92, ls: 0 },
        // SHA3-512 digest
        "1AAK" => Sizage { hs: 4, ss: 0, fs: 92, ls: 0 },
        // Blake2b-512 digest
        "1AAL" => Sizage { hs: 4, ss: 0, fs: 92, ls: 0 },
        // SHA2-512 digest
        "1AAM" => Sizage { hs: 4, ss: 0, fs: 92, ls: 0 },
        ...
        "4A" => Sizage { hs: 2, ss: 2, fs: 0, ls: 0 }, // String variable length base64
        "4B" => Sizage { hs: 2, ss: 2, fs: 0, ls: 0 }, // Bytes variable length base64

        // Variable-length codes starting with 5
        "5A" => Sizage { hs: 2, ss: 2, fs: 0, ls: 0 }, // String variable length base2
        "5B" => Sizage { hs: 2, ss: 2, fs: 0, ls: 0 }, // Bytes variable length base2

        // Variable-length codes starting with 6
        "6A" => Sizage { hs: 2, ss: 2, fs: 0, ls: 0 }, // String variable length large base64
        "6B" => Sizage { hs: 2, ss: 2, fs: 0, ls: 0 }, // Bytes variable length large base64
        ...
        "8AAA" => Sizage { hs: 4, ss: 4, fs: 0, ls: 0 },
        "8AAB" => Sizage { hs: 4, ss: 4, fs: 0, ls: 0 },

        // Variable-length codes starting with 9
        "9AAA" => Sizage { hs: 4, ss: 4, fs: 0, ls: 0 },
        "9AAB" => Sizage { hs: 4, ss: 4, fs: 0, ls: 0 },
