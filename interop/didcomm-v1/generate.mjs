...
// Read the provenance from what is actually installed, not from a literal.
// These strings are the only record of which Credo produced the committed
// fixtures, and a hand-maintained copy silently keeps claiming the old version
// after an upgrade — which is exactly what happened across 0.6.3 -> 0.7.0.
const require = createRequire(import.meta.url)
const INSTALLED = {
  credo: require('@credo-ts/core/package.json').version,
  askar: require('@openwallet-foundation/askar-nodejs/package.json').version,
}
...
const fixtures = {
  generator: {
    credo: INSTALLED.credo,
    askar: INSTALLED.askar,
